...
import MoreDoesNotMeanBetterPhoto from "../../../assets/articles/More_Doesnt_Always_Mean_Better.png";

const MoreDoesNotMeanBetter = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-20 py-12 bg-gray-50">
      ...
      <div className="relative w-full max-w-6xl mx-auto mb-8">
        <img
          src={MoreDoesNotMeanBetterPhoto}
      ...
      <div className="max-w-6xl mx-auto space-y-16 text-gray-700 text-sm sm:text-base leading-relaxed">
        ...
        <section id="simplicity-efficiency" className="text-left px-4">
          ...
          <p>
            Let’s be honest—no one has time to figure out a complex app when
            they’re out assessing hail damage or reviewing claims. Every
            unnecessary step or feature is wasted time. Obai understands this,
            which is why we prioritize simplicity. We build our app with one
            thing in mind: getting appraisers and insurance companies through
        ...
        <section id="why-overcomplicate" className="text-left px-4">
          ...
          <p>
            Imagine an app filled with features that are rarely used. It’s
            confusing, frustrating, and slows down the claims process. More
        ...
        <section id="the-obai-way" className="text-left px-4">
          ...
          <p>
            We built our hail claims app to streamline the process. Each feature
            is designed with a clear purpose: to help appraisers and insurance
        ...
        >
          <div className="text-left text-sm sm:text-base">
            ...
            <p className="text-gray-600">
              Contact Obai today to learn how our streamlined hail claims app
              can help your team work faster, smarter, and more efficiently.
            </p>
          </div>
...
export default MoreDoesNotMeanBetter;
